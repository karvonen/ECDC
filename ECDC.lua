...
function ECDC_LoadSkills()
	ECDC_Skills = {
		...
		{name = "Blade Flurry", cooldown = 120, desc = "Unknown!", icon = "Ability_Warrior_Punishingblow"},
		{name = "Adrenaline Rush", cooldown = (6*60), desc = "Unknown!", icon = "Spell_Shadow_Shadowworddominate"},
		{name = "Preparation", cooldown = 600, desc = "Unknown!", icon = "Spell_Shadow_Antishadow"},
		{name = "Ghostly Strike", cooldown = 20, desc = "Unknown!", icon = "Spell_Shadow_Curse"},
		{name = "Premeditation", cooldown = 60, desc = "Unknown!", icon = "Spell_Shadow_Possession"},
		{name = "Cold Blood", cooldown = 180, desc = "Unknown!", icon = "Spell_Ice_Lament"},

		{name = "Bestial Wrath", cooldown = 120, desc = "Unknown!", icon = "Ability_Druid_Ferociousbite"},
		{name = "Intimidation", cooldown = 60, desc = "Unknown!", icon = "Ability_Devour"},
		{name = "Deterrence", cooldown = (5*60), desc = "Unknown!", icon = "Ability_Whirlwind"},
		{name = "Scatter Shot", cooldown = 30, desc = "Unknown!", icon = "Ability_Golemstormbolt"},

		{name = "Last Stand", cooldown = 600, desc = "Unknown!", icon = "spell_holy_ashestoashes"},

		{name = "Inner Focus", cooldown = 180, desc = "Unknown!", icon = "spell_frost_windwalkon"},
		{name = "Power Infusion", cooldown = 180, desc = "Unknown!", icon = "spell_holy_powerinfusion"},
		{name = "Silence", cooldown = 45, desc = "Unknown!", icon = "spell_shadow_impphaseshift"},

		{name = "Elemental Mastery", cooldown = 180, desc = "Unknown!", icon = "spell_nature_wispheal"},
		{name = "Stormstrike", cooldown = 20, desc = "Unknown!", icon = "spell_holy_sealofmight"},
		{name = "Nature's Swiftness", cooldown = 180, desc = "Unknown!", icon = "spell_nature_ravenform"},

		{name = "Fel Domination", cooldown = (15*60), desc = "Unknown!", icon = "Spell_Nature_Removecurse"},

		{name = "Divine Favor", cooldown = 120, desc = "Unknown!", icon = "spell_holy_heal"},
		...
		{name = "Innervate", cooldown = (6*60), desc = "Unknown!", icon = "spell_nature_lightning"},
		...
		{name = "Presence of Mind", cooldown = 180, desc = "Unknown!", icon = "spell_nature_enchantarmor"},
		{name = "Arcane Power", cooldown = 180, desc = "Unknown!", icon = "Spell_Nature_Lightning"},
		{name = "Combustion", cooldown = 180, desc = "Unknown!", icon = "spell_fire_sealoffire"},
		...
		-- Intercept cd is 30s, -5s pvp gear
		{name = "Intercept Stun", cooldown = 25, desc = "Charge an enemy, causing 65 damage and stunning it for 3 sec.", icon = "Ability_Rogue_Sprint"},
		...
		-- Frost Nova base cd is 25s, -4s talent.
		{name = "Frost Nova", cooldown = 21, desc = "Blasts enemies near the caster for 71 to 79 Frost damage and freezes them in place for up to 8 sec. Damage caused may interrupt the effect.", icon = "Spell_Frost_FrostNova"},
